...
<div class="row row-overflow">
  ...
  <div class="col-lg-12 eqLogicThumbnailDisplay" id="listCol">
    ...
    <legend><i class="fas fa-home" id="butCol"></i> {{Mes équipements}}</legend>
    <div class="eqLogicThumbnailContainer">
      ...
      foreach ($eqLogics as $eqLogic) {
        ...
        echo '<div class="eqLogicDisplayCard cursor" data-eqLogic_id="' . $eqLogic->getId() . '" style="background-color : #ffffff ; height : 180px !important;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 180px;margin-left : 10px;' . $opacity . '" >';
				...
				echo '<span style="font-size:10px" class="subname">(' . $eqLogic->getConfiguration('ip') . ')</span>';
				echo '</div>';
      }
      ?>
    </div>
...
<div class="col-lg-12 col-md-9 col-sm-8 eqLogic" id="listOtherCol" style="border-left: solid 1px #EEE; padding-left: 25px;display: none;">
